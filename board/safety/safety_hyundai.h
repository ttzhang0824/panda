...
AddrCheckStruct hyundai_addr_checks[] = {
  {.msg = {{0x260, 0, 8, .check_checksum = true, .max_counter = 3U, .expected_timestep = 10000U},
           ...
           {0x260, 1, 8, .check_checksum = true, .max_counter = 3U, .expected_timestep = 10000U}}},
  {.msg = {{0x386, 0, 8, .check_checksum = true, .max_counter = 15U, .expected_timestep = 10000U},
           {0x386, 1, 8, .check_checksum = true, .max_counter = 15U, .expected_timestep = 20000U}, { 0 }}},
  {.msg = {{0x394, 0, 8, .check_checksum = true, .max_counter = 7U, .expected_timestep = 10000U},
           {0x394, 1, 8, .check_checksum = true, .max_counter = 7U, .expected_timestep = 20000U}, { 0 }}},
  {.msg = {{0x421, 0, 8, .check_checksum = true, .max_counter = 15U, .expected_timestep = 20000U},
           {0x421, 1, 8, .max_counter = 14U, .expected_timestep = 20000U}, { 0 }}},
};
...
static int hyundai_rx_hook(CANPacket_t *to_push) {
  ...
  if (valid && (addr == 0x421) && (bus == scc_bus)) {
...
static int hyundai_tx_hook(CANPacket_t *to_send) {
  ...
  if (hyundai_longitudinal) {
    ...
    tx = msg_allowed(to_send, HYUNDAI_CAN_CANFD_HDA2_TX_MSGS, sizeof(HYUNDAI_CAN_CANFD_HDA2_TX_MSGS)/sizeof(HYUNDAI_CAN_CANFD_HDA2_TX_MSGS[0]));
  } else {
